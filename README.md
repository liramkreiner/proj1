...
| POST | `/api/sessions` | start a match (role, seed, optional custom matrix) |
| POST | `/api/sessions/{id}/turn` | play one penalty |
| POST | `/api/sessions/{id}/reset` | restart the match |
